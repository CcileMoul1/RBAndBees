...
- [App presentation](#app-presentation)
	- [Overview](#overview)
	- [Detailed description (use cases)](#detailed-description) 
- [How to](#how-to)
- [ToDo list](#todo-list)
- [Choices](#choices)
...
1. A not-logged user can 
	- see the properties in a carousel format
...
Property has the following attributes
	...
	- capacity (integer) capacity in term of bedding
	...
	Constraints : the price is positive but could be 0 (free) and the capacity is strictly positive.
	Added on the DB because it's the base ground of the app.
